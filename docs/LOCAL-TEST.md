...
AI rulează cu `AI_DEFAULT_PROVIDER=mock`, iar interfața afișează permanent modul de test. OCR real, DOCX, SMTP/S3 reale și notificările externe nu au fost validate în acest increment. Tokenurile sesiunii sunt încă în localStorage: cookie HttpOnly și stocare nativă securizată rămân condiții pentru lansare publică.
